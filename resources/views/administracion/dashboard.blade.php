...
<body class="bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen">
    ...
    <aside class="fixed left-0 top-0 h-screen w-72 bg-gradient-to-b from-gray-900 to-gray-800 text-white shadow-2xl z-50">
        ...
        <div class="absolute bottom-0 w-full p-4 border-t border-gray-700 space-y-2">
            ...
            <a href="{{ url('/') }}" class="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 rounded-xl font-semibold transition-all group">
